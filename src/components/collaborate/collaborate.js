...
const Collaborate = () => {
  return (
    <div className="w-full flex justify-center">
      <div className="w-full max-w-[1440px] py-[60px] px-[160px] flex flex-col items-center gap-[40px]">
        <div className="w-full flex flex-col gap-[24px] items-center">
          <div className="px-4 py-2 rounded-[40px] border border-[rgba(255,255,255,0.75)] bg-[rgba(255,250,209,0.04)] shadow-[0px_0px_12px_0px_#FFC872_inset] flex justify-center items-center">
            <div className="text-[18px] leading-[24px] bg-[linear-gradient(90deg,#FFFCF5_-0.05%,#E5B865_37.73%,#F27969_82.63%)] bg-clip-text text-transparent">
              Collaborating for the Future
            </div>
          </div>
          <div className="w-full max-w-[500px] bg-[linear-gradient(91deg,#FFF-1.2%,#B0B1B4_99.77%)] text-[48px] font-medium leading-[52px] tracking-[-1px] gradientSilver text-center">
            Shaping Decentralized Finance Together
          </div>
          <div className="text-[rgba(255,255,255,0.66)] text-center text-[16px] leading-[22px] font-light w-full max-w-[687px]">
        ...
        <div className="w-full px-[120px] flex gap-[16px]">
          <div className="grow h-[612px] bg-[url('/images/collaborate/bgChip.png')] bg-cover rounded-[24px] overflow-hidden"></div>
          <div className="w-full max-w-[363px] flex flex-col">
