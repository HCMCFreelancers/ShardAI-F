  ...
  return (
    <div className="md:max-w-[1440px] max-w-[414px] overflow-hidden w-full md:px-40 md:py-[60px] px-4 py-6 relative md:h-[903px] h-[750px]">
      <div className="w-full flex flex-col items-center relative">
        ...
        >
          Multiple Parallel Mining With Shards
        </motion.div>
        {/* content */}
        <motion.div
          ref={ref3}
        ...
        >
          Sharding is parallelizing the network into partitions that are built
          into the protocol itself, with the same security guarantees. Both
          processing and state are completely sharded, the throughput almost
